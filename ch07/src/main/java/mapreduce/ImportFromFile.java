...
public class ImportFromFile {
     ...
     */
    // vv ImportFromFile
    private static CommandLine parseArgs(String[] args) { // co ImportFromFile-6-ParseArgs Parse the command line parameters using the Apache Commons CLI classes. These are already part of HBase and therefore are handy to process the job specific parameters.
